...
#
#
# this bit is really important for adding things from dummy json
#
#
# Load environment variables from .env
config = Config(".env") #dummy json file in the env
...
def dataInitDB() :
    ...
    # Get data
    #this is the responce for putting data to the page from env file
